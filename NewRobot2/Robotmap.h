...
#define SD_PREP_KICK_PLAT_HEIGHT     	"Prep_Kick_Platform_Height"
#define SD_PREP_KICK_THRESHOLD_HEIGHT 	"Prep_Kick_Threshold_Height"
#define SD_KICK_SPEED_FWD               "Kicker_Speed_Forward"
//   Debug string values
