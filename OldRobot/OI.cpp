...
#include "Commands/Fire3Frisbees.h"
...
OI::OI() {
	...
	releaseArm = new JoystickButton(joy3, 8);
	releaseArm->WhenPressed(new MoveShoulder());
	startBelt = new JoystickButton(joy3, 5);
	startBelt->WhenPressed(new MoveBelt());
	joy2 = new Joystick(2);
	...
	SmartDashboard::PutData("Fire3Frisbees", new Fire3Frisbees());
